...
namespace Ds.Helper
{
    public static class Extensions
    {
        ...
        public static bool Op1HasLowerOrEqualPrecedence(this char op1, char op2)
            => op1.OperatorPrecedence() <= op2.OperatorPrecedence();
        ...
        /// <summary>
        /// Returns true if the str contains any of the following arithmetic operators: +, -, /, *.
        /// False otherwise.
        /// </summary>
